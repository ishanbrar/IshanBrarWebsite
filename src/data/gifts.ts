...
export const gifts: Gift[] = [
  ...
  },
  {
    ...
    letter:
      "WikiMe turns a short intake—facts about you, a headshot, optional screenshots—into a full Wikipedia-style article with infobox, sections, and linked prose generated by Gemini. " +
      "You can edit sections, regenerate individual parts, crop your headshot for the infobox, and export or share a public slug when you are happy with the page. " +
      "Accounts and saved articles live in Supabase, so your drafts persist across sessions instead of vanishing after one generation. " +
      "I built it because everyone deserves a biography page that looks official, even when Wikipedia will never accept the subject. " +
      "The live app is on Vercel; the source is on GitHub if you want to see the Next.js and API routes behind the curtain.",
  },
  {
    id: "punjabitutor",
